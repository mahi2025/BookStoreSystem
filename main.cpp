...
int main() {
    ...
    loadBooksFromFile(books, numBooks); // You'll need to update this function to handle the array
            ...
            case 2: {
                if (numBooks < MAX_BOOKS) {
                    ...
                    try {
                        ...
                        books[numBooks] = newBook;  // Insert book in array
                        numBooks++;  // Increment book count
                        saveBooksToFile(books, numBooks);  // Update file saving function
